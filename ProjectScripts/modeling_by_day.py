...
# pd.to_pickle(df_day, r"C:\CS577 Project\Data\df_day")
...
#pickle_dump(scaler, r"C:\CS577 Project\Data\FutureDataSaves\minmaxclf.pkl")
# clf.fit(all_data, all_y)
# pickle_dump(clf, r"C:\CS577 Project\Data\FutureDataSaves\random_forest.pkl")
...
# corrs = pickle_load(r"C:\CS577 Project\Data\correlationTable")
#
# corrs = corrs.dropna()
...
#
# #pickle_dump(rf_result, r"C:\CS577 Project\Data\rf_byDay_keepSome")
# rf_result = pickle_load(r"C:\CS577 Project\Data\rf_byDay_dropAll")
