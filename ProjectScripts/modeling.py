...
from preprocessing import pickle_load, pickle_dump
...
def main():
    path = r"C:\CS577 Project\Data\final_df"
    df = pickle_load(path)
    ...
    # pickle_dump(result2, r"C:\CS577 Project\Data\logit_result_0.7ratio")
    result = pickle_load(r"C:\CS577 Project\Data\logit_result")
    result2 = pickle_load(r"C:\CS577 Project\Data\logit_result_0.7ratio")
    ...
    #pickle_dump(res,r"C:\CS577 Project\Data\rf_result")
    #
    ...
    #pd.to_pickle(clf, r"C:\CS577 Project\Data\rf_fit_all")
    clf = pd.read_pickle(r"C:\CS577 Project\Data\rf_fit_all")
